...
export default function MergeBoard({ 
  ...
  return (
    <div className="grid grid-cols-7 gap-1.5 p-2 sm:p-4 rounded-2xl bg-card/30 backdrop-blur-sm border border-solid border-white/30 w-full max-w-2xl mx-auto shadow-lg">
